...
<Screenshot src={titleSuffixImage} alt="Customized Logo" />
...
import { Tabs, Tab } from "@/nextra"

<Screenshot src={titleSuffixImage} alt="Customized Sidebar" />
...
<Screenshot src={titleSuffixImage} alt="Navigation" full />
