...
export default function Header() {
    return (
        ...
        <Navbar>
            ...
            <a href="https://genea-workshop.github.io/2024/" target="blank" rel="blank" className="mr-10 text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false">GENEA 2024 ↗</a>
            ...
            <a href="https://twitter.com/WorkshopGenea" target="blank" rel="noreferrer">
                <Twitter />
            </a>
        </Navbar>
        //     </nav>
