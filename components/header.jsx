    ...
    return (
        <div className="nextra-nav-container sticky top-0 z-20 w-full bg-transparent print:hidden">
            ...
            <nav className="mx-auto flex h-[var(--nextra-navbar-height)] max-w-[90rem] items-center justify-end gap-4 pl-[max(env(safe-area-inset-left),1.5rem)] pr-[max(env(safe-area-inset-right),1.5rem)]">
                <a className="flex items-center hover:opacity-75 ltr:mr-auto rtl:ml-auto" href="/">
                ...
                <a className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap font-medium subpixel-antialiased" aria-current="true" href="/en/docs/getting-started">Docs</a>
                ...
                <a className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false" href="/en/examples/basic">Examples</a>
                <a className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false" href="/en/blog">Blog</a>
                <a href="https://github.com/GENEA" target="blank" rel="noreferrer" className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false">Visit me ↗</a>
                ...
                <a href="https://github.com/vercel/swr" target="blank" rel="noreferrer">
                    <Github/>
                    <span className="sr-only">GitHub</span>
                </a>
                <a href="https://twitter.com/GENEA" target="blank" rel="noreferrer">
                    <Twitter/>
                </a>
            </nav>
        </div>
